...
```bash
bash src/analyses/progression/run_disease_progression.sh --overwrite
```
...
[`src/analyses/eight_electrode/`](../src/analyses/eight_electrode/README.md).
