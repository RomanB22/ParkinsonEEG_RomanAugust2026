...
- `outputs/full/psd/metrics/group_{subject,electrode}_statistics.csv`
- `outputs/full/ordinal/metrics/group_*_statistics_*.csv`
- `outputs/full/scale_free/metrics/group_*_statistics_*.csv`
- `outputs/full/bycycle/metrics/group_{subject,electrode}_statistics.csv`
- `outputs/full/bouts/metrics/group_{subject,electrode}_statistics.csv`
