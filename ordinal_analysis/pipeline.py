...
from .metrics import METRICS, analyze_epoch_data, subject_electrode_means
from .plots import (
    metric_color_limits,
...
def load_analysis_config(path: str | Path) -> dict[str, Any]:
    ...
    required = {"input", "output_dir", "ordinal", "plots"}
...
def run_analysis(
    ...
    *,
    ...
    logger.info(
        "Starting ordinal analysis | subjects=%d | dx=%d | tau=%d | tie_precision=%s",
