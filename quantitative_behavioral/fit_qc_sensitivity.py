...
from quantitative_behavioral.plots import (
    plot_family_forest,
    plot_family_heatmap,
    plot_family_scatter_grid,
)
from quantitative_behavioral.statistics import correlate_subject_features
...
def run_behavioral_fit_qc_sensitivity(
    config_path: str | Path = "quantitative_behavioral/config.json",
    *,
    scale_free_qc_subject_file: str | Path = (
        "scale_free_analysis/processed/metrics/subject_band_metrics_fit_qc.csv"
    ),
    bout_ordinal_qc_subject_file: str | Path = (
        "bout_analyses/processed/metrics/subject_band_metrics_fit_qc.csv"
    ),
) -> dict[str, Any]:
