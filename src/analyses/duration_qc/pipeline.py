...
from analyses.exploration.matching import remove_demographic_predictors
...
from analyses.behavioral.pipeline import load_analysis_config as load_behavioral_config
from analyses.behavioral.statistics import correlate_subject_features, fdr_bh
...
def run_duration_sensitivity(
    config_path: str | Path = "config/analyses/duration_qc.json",
    *,
    matched: bool = False,
