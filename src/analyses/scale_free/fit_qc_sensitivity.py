...
from analyses.bouts.metrics import METRICS as BOUT_ORDINAL_METRICS
from analyses.bouts.pipeline import _group_summary as bout_ordinal_group_summary
from analyses.bouts.pipeline import _subject_band_means as bout_ordinal_subject_means
from analyses.scale_free.metrics import BAND_FEATURES
...
def run_fit_qc_sensitivity(
    *,
    scale_free_output: str | Path = "outputs/full/scale_free",
    bout_ordinal_output: str | Path = "outputs/full/bouts",
