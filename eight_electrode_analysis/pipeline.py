...
from bout_analyses.pipeline import GROUP_METRICS
from ordinal_analysis.metrics import METRICS as ORDINAL_METRICS
from scale_free_analysis.metrics import APERIODIC_FEATURES, BAND_FEATURES
...
def run_analysis(
    config_path: str | Path = "eight_electrode_analysis/config.json", *, overwrite: bool = False
) -> dict[str, Any]:
